...
from tanks.scenes.speed_2 import Speed2

class Speedmap20(SceneBase):
    """스피드 모드 레벨 선택 메뉴 장면"""

    def __init__(self):
        super().__init__()
        self.levels = Speed2.get_available()
        self.current_page = 0
        self.level_buttons = []
        ...
        for btn in self.level_buttons:
            btn.on_click = lambda b: load_scene(Speed2(b.raw_text + '.txt'))
